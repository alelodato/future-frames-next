    ...
    <section className="min-h-screen bg-[#02010b] text-white">
      <div className="relative min-h-screen overflow-hidden">
        ...
        <div className="relative z-10 mx-auto flex max-w-5xl flex-col items-center justify-end px-4 pb-24 pt-60 text-center md:pb-32 md:pt-36 lg:pb-40 lg:pt-40">
          ...
          <h1 className="hero-services-title font-antonio font-semibold text-3xl sm:text-4xl lg:text-[2.9rem] leading-snug md:leading-[1.15]">
            Creatività, Qualità Professionale
            <br className="hidden sm:block" />
            <span className="block">e massima Affidabilità.</span>
          </h1>
      ...
      <div className="mx-auto max-w-6xl px-4 py-10 sm:py-16 space-y-16 sm:space-y-24 min-h-screen bg-gradient-to-b from-black via-[#0a0b338d] to-[#45115d5c]">
        ...
        >
          <div className="space-y-6">
            ...
            <div className="relative md:hidden">
              ...
              <div className="relative h-56 w-full overflow-hidden rounded-3xl border border-white/12 bg-white/5 shadow-[0_22px_70px_rgba(0,0,0,0.75)]">
                <img
            ...
            <div className="rounded-3xl border border-white/10 bg-white/5 backdrop-blur-md p-6 md:p-8 shadow-[0_22px_70px_rgba(0,0,0,0.75)]">
              <ul className="space-y-3 font-montserrat text-sm md:text-base leading-relaxed text-zinc-200">
                ...
                <li>Ideale per feste, lanci di prodotto, eventi culturali, convention.</li>
              </ul>

              <Link
                href="/contact"
                className="inline-flex mt-6 items-center justify-center rounded-full bg-violet-500 px-6 py-2 text-xs font-montserrat uppercase tracking-[0.2em] text-black hover:bg-violet-400 transition shadow-[0_0_30px_rgba(167,139,250,0.7)]"
              >
          ...
          <div className="relative hidden md:block">
            <div className="absolute -top-6 -left-6 h-44 w-44 rounded-3xl bg-gradient-to-br from-violet-600/70 via-fuchsia-500/40 to-sky-500/40 blur-[26px]" />
            <div className="relative h-72 lg:h-80 w-full overflow-hidden rounded-3xl border border-white/12 bg-white/5 shadow-[0_26px_90px_rgba(0,0,0,0.85)]">
              <img
                src="/images/eventi.webp"
                alt="Eventi"
                className="h-full w-full object-cover"
        ...
        >
          ...
          <div className="order-2 md:order-1">
            ...
            <div className="relative md:hidden">
              ...
              <video
                className="relative w-full h-56 object-cover rounded-3xl border border-white/12 bg-white/5 shadow-[0_26px_90px_rgba(0,0,0,0.85)]"
            ...
            {/* VIDEO DESKTOP */}
            <div className="relative hidden md:block">
              <div className="absolute -bottom-6 -right-6 h-44 w-44 rounded-3xl bg-gradient-to-tr from-violet-600/70 via-fuchsia-500/40 to-sky-500/40 blur-[26px]" />
              <video
                className="relative w-full h-72 lg:h-80 object-cover rounded-3xl border border-white/12 bg-white/5 shadow-[0_30px_100px_rgba(0,0,0,0.9)]"
                src="/videos/ToyotaXReply.mp4"
                autoPlay
                muted
                loop
          ...
          <div className="order-1 md:order-2">
            ...
            <h3 className="font-antonio text-lg md:text-xl mb-6">
              E <strong>PARLANO</strong> DIRETTAMENTE AL TUO PUBBLICO.
            </h3>

            <div className="rounded-3xl border border-white/10 bg-white/5 md:bg-transparent md:border-transparent backdrop-blur-md md:backdrop-blur-0 p-6 md:p-0 shadow-[0_22px_70px_rgba(0,0,0,0.75)] md:shadow-none">
              ...
              <Link
                href="/contact"
                className="inline-flex mt-6 items-center justify-center rounded-full bg-violet-500 px-6 py-2 text-xs font-montserrat uppercase tracking-[0.2em] text-black hover:bg-violet-400 transition"
              >
                Richiedi un preventivo
              </Link>
            </div>
        ...
        <section id="cerimonie" className="space-y-6" data-aos="fade-up">
          <h2 className="font-antonio text-2xl md:text-3xl font-semibold leading-snug">
            ...
            <strong>PER SEMPRE</strong>, con <strong>EMOZIONI</strong> vere e
            spontanee.
          </h2>

          <div className="grid gap-8 md:gap-12 md:grid-cols-2 items-center">
            <div className="relative">
              <div className="relative h-64 md:h-72 w-full overflow-hidden rounded-3xl border border-white/12 bg-white/5 shadow-[0_26px_90px_rgba(0,0,0,0.85)]">
                <img
              ...
              <div className="absolute -bottom-6 right-6 h-40 md:h-44 w-44 md:w-48 overflow-hidden rounded-3xl border border-white/12 bg-white/5 shadow-[0_22px_70px_rgba(0,0,0,0.85)]">
                <img
        ...
        >
          <div className="space-y-6">
            ...
            <div className="relative md:hidden">
              ...
              <div className="relative h-56 w-full overflow-hidden rounded-3xl border border-white/12 bg-white/5 shadow-[0_26px_90px_rgba(0,0,0,0.85)]">
                <img
          ...
          {/* IMG DESKTOP */}
          <div className="relative hidden md:block">
            <div className="absolute -top-6 -right-6 h-44 w-44 rounded-3xl bg-gradient-to-br from-amber-400/60 via-violet-500/40 to-emerald-400/40 blur-[26px]" />
            <div className="relative h-64 lg:h-72 w-full overflow-hidden rounded-3xl border border-white/12 bg-white/5 shadow-[0_26px_90px_rgba(0,0,0,0.85)]">
              <img
                src="/images/introimg6.webp"
                alt="food"
                className="h-full w-full object-cover"
        ...
        {/* MONTAGGIO */}
        <div id="montaggio" className="space-y-6" data-aos="fade-up">
          ...
          <div className="grid gap-8 md:gap-12 md:grid-cols-[1.15fr,1fr] items-center">
            <div className="relative overflow-hidden rounded-3xl border border-white/12 bg-white/5 shadow-[0_26px_90px_rgba(0,0,0,0.85)] h-64 md:h-72 lg:h-80">
              <img
            ...
            <div className="rounded-3xl border border-white/10 bg-white/5 backdrop-blur-md p-6 md:p-8 shadow-[0_22px_70px_rgba(0,0,0,0.75)]">
              <ul className="space-y-3 font-montserrat text-sm md:text-base leading-relaxed text-zinc-200">
                ...
                <li>
                  <h5 className="text-zinc-100">Spot pubblicitari</h5>
                </li>
                <li>
                  <h5 className="text-zinc-100">Videoclip musicali</h5>
                </li>
                <li>
              ...
              <Link
                href="/contact"
                className="mt-6 inline-flex items-center justify-center rounded-full bg-violet-500 px-6 py-2 text-xs font-montserrat font-semibold uppercase tracking-[0.2em] text-black transition hover:bg-violet-400 shadow-[0_0_30px_rgba(167,139,250,0.55)]"
              >
                Richiedi un preventivo
              </Link>
            </div>

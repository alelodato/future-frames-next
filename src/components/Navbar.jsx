...
export default function Navbar() {
  ...
  return (
    <>
      ...
      >
        <div className="max-w-[1400px] mx-auto flex items-center justify-between h-[72px] px-6 md:p-10 lg:p-16">
          ...
          <Link href="/" onClick={close} className="flex-shrink-0 z-10 my-6 group">
            <img
              ...
              alt="Future Frames"
              className="h-16 sm:h-16 md:h-20 lg:h-28 my-2 w-auto transition-all duration-300
